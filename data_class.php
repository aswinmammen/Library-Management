...
class data extends db {
    ...
    function addnewuser($name,$pasword,$email,$type,$userid){
        $this->name=$name;
        ...
        $this->userid=$userid;
         ...
         $q="INSERT INTO userdata(id, name, email, pass,type,userid)VALUES('','$name','$email','$pasword','$type','$userid')";
    ...
    function addbook($bookpic, $bookname, $bookdetail, $bookaudor, $bookpub, $branch, $bookprice, $bookquantity,$bkid) {
        ...
        $q = "INSERT INTO book (id, bookpic, bookname, bookdetail, bookaudor, bookpub, branch, bookprice, bookquantity, bookava, bookrent, bkid) 
        VALUES ('', '$bookpic', '$bookname', '$bookdetail', '$bookaudor', '$bookpub', '$branch', '$bookprice', '$bookquantity', '$bookquantity', '$bookquantity', '$bkid')";
